...
public class BookRepositoryImpl implements BookRepository {
	...
	//17장 추가 JdbcTemplate 클래스의 속성에 대한 Setter()추가
	...
	public List<Book> getBookListByCategory(String category) 
	{
		 ...
		 * 
		 * if(category.equalsIgnoreCase(book.getCategory())) bookByCategory.add(book); }
		 */
	...
	public Book getBookById(String bookId) {
		 ...
		 * book.getBookId().equals(bookId)) { bookInfo = book; break; } }
		 */
		if(bookInfo == null) {
